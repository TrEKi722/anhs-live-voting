...
const YEARBOOK_TEACHERS = [
    ...
    { id: 2, name: 'Coach Calahan', gender: 'm' },
    ...
    { id: 7, name: 'Mr. Golden', gender: 'm' },
    { id: 8, name: 'Coach Colwell', throwbackExt: 'jpeg', gender: 'm' },
    { id: 9, name: 'Srta. Rodriguez', gender: 'f' },
    { id: 10, name: 'Mrs. Akbarzadeh', gender: 'f' },
    { id: 11, name: 'Mrs. Austin', gender: 'f' },
    { id: 12, name: 'Mr. Skinner', gender: 'm' },
    { id: 13, name: 'Mrs. Erhard', gender: 'f' },
    { id: 14, name: 'Mr. Harney', gender: 'm' },
    { id: 15, name: 'Keith', gender: 'm' },
    { id: 16, name: 'Ms. Murphy', gender: 'f' },
    { id: 17, name: 'Mr. Schniepp', throwbackExt: 'png', gender: 'm' },
    { id: 18, name: 'Mr. Silberman', throwbackExt: 'png', gender: 'm' },
